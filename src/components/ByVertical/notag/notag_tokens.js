...
function NotagFetch (){
    ...
    const infocollectionRef = collection(db, 'notagtokens')
    ...
    async function updateFiret(adrsxy) {
        ...
        // Add a new document in collection "notagtokens" with id 'addressX'
        await setDoc(doc(db, "notagtokens", adrsxy), {
            address: adrsxy,
            viewed: true
        });
    }
                ...
                function getTimer(i){
                    ...
                    .then((data)=>{
                        ...
                        if(trades.length > 0){
                            ...
                            notag_tokens[i]["Timestamp"] = convertUnixTime(timest)

                        }else{
                            notag_tokens[i]["Timestamp"] = "No time found..."
                        }
