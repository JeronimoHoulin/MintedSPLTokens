                ...
                function getTimer(i) {
                    ...
                    .then((data)=>{
                        ...
                        if(trades.length > 0){
                            ...
                            meme_tokens[i]["Timestamp"] = timest
                        ...
                        //Set table
                            ...
                            for(let i = 0; i < meme_tokens.length; i++){
                                ...
                                let timestampx = null
                                if(typeof meme_tokens[i].Timestamp === 'string'){
                                    timestampx = meme_tokens[i].Timestamp
                                }else{ timestampx =convertUnixTime(meme_tokens[i].Timestamp)}
